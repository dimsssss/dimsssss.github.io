...
[동시성 문제가 발생](https://i.imgur.com/gwebm42.mp4)
...
[mysql 잠금을 이용한 동시성 처리(비관적 락)](https://i.imgur.com/HcM7PUJ.mp4)
...
[낙관적 락을 이용한 동시성 테스트(with k6)](https://i.imgur.com/M2xv11v.mp4)
...
[배포 서버를 대상으로 테스트(with k6)](https://i.imgur.com/YY9ms6N.mp4)
